const I_AM_A_PLACEHOLDER_SO_THE_COMMENT_BELOW_IS_TRANSFERRED_FROM_ADPHARM_SHAD = "";
// The following comment is required.
/**
...
// Access env vars like this:
// window.env?.PUBLIC_APP_ENV || "development"
// window.env?.PUBLIC_APP_FQDN || ""
