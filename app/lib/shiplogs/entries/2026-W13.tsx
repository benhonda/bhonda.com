...
export const shiplogMeta = {
  ...
  previewText: "Shipped email-based team invites, major performance improvements across the stack, and stricter quality controls for captured content.",
...
export default function Shiplog2026W13() {
  return (
    <ShiplogLayout meta={shiplogMeta}>
      ...
      <Text as="p" variant="body">
        Search results now show personalized suggestions on the hero section based on your query patterns. Behind the scenes, content is now sorted by <InlineCode>ai_design_score</InlineCode> instead of embedding distance, improving relevance. Captures with design scores below 2.0 are automatically rejected before entering the index.
      </Text>
      ...
      <Text as="p" variant="body">
        Fixed a bug where third-party scripts were monkey-patching <InlineCode>console.log</InlineCode>, breaking debug output. Hardened the recording pipeline with AMI pinning, better error propagation, and framerate adjustments.
      </Text>
      ...
      <Text as="p" variant="body">
        Published two new FAQ entries: one covering Google Ads Search Campaigns and another on HTTPS feed sources. Audited all existing FAQs to remove fluff. Added an Accordion component to support expandable Q&A sections. Added project page for <Tag project="bunny-cache-buster" />.
      </Text>
